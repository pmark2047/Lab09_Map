...
public:
   ...
   {  // setup
      ...
      // verify
      assertUnit(NOT_YET_IMPLEMENTED);
      // a blank Spy is created for comparison
      // destroy it and the move-copy when done
      //    "30"     "50"     "70"   = m
      //   +----+   +----+   +----+
      //   | 30 | - | 50 | - | 70 |
      //   +----+   +----+   +----+
   ...
   {  // setup
      ...
      // a blank Spy is created for comparison
      // destroy it and the move-copy when done
      // use the assignment operator for [50]
      assertUnit(NOT_YET_IMPLEMENTED);
      //    "10"     "30"     "50"     "70"   = m
      //   +----+   +----+   +----+   +----+
      //   | 10 | - | 30 | - | 50 | - | 70 |
   ...
   {  // setup
      ...
      // verify
      assertUnit(NOT_YET_IMPLEMENTED);
      // destroy [50] and default for find
      // delete  [50]  
      // create default for find
      //    "30"     "70"   = m
      //   +----+   +----+
      //   | 30 | - | 70 |
      //   +----+   +----+
